...
public class AdminOrderManageController {
	...
	@Autowired ProductRegistrationService productService;
...
/*	@GetMapping("/admin/admin-productRegistration.do")
	public String adminProductRegistration(@RequestParam(value = "productIndex", required = true) String productIndex) {
