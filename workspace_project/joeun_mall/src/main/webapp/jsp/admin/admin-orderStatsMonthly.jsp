...
<html lang="ko">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/admin-stats-monthlygraph.css">
    </head>
    ...
    <body>
        <div id="wrap">
            ...
            <section>
                ...
                <div><!-- 전체 항목 보기 버튼 -->
                    <input type="button" value="전체 항목 보기" id="monthCompare-btn" style="cursor:pointer" onclick="location.href='<%=request.getContextPath()%>/admin-orderStatsGraph.do'">
                </div>
