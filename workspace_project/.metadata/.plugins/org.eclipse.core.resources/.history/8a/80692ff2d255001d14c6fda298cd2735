...
public class InquiryTBLVO implements Serializable {
	...
	/** 문의 번호 : '문의일자 6자리' + '해당년도 문의순서 3자리' */
	private String inquiryIndex;
	
	/** 고객 번호 : '가입년도 4자리' + '해당년도 가입순서 3자리' */
	...
	public InquiryTBLVO(String inquiryIndex, String userIndex, Date inquiryDate, String inquiryCategory, String inquiryState, String inquiryTitle, String inquiryContent, String inquiryAnswer) {
	...
	public String toString() {
		return "InquiryTBLVO [inquiryIndex=" + inquiryIndex + ", userIndex=" + userIndex + ", inquiryDate="
				+ inquiryDate + ", inquiryCategory=" + inquiryCategory + ", inquiryState=" + inquiryState
