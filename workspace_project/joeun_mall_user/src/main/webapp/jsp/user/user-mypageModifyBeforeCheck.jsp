...
<body>
    <div id="wrap">
        <header>
            <a href="/user/user-productlistAll.do"><img id="logo" src="<c:url value='/images/logo/logo_transparent.png" alt="JoEunMall' />"></a>
            <ul id="header">
                <li><a href="#">전상품</a></li>
                <li><a href="#">티셔츠</a></li>
            ...
            <nav>
                ...
                <div class="mypage-list">
                    ...
                    <ul class="mypage-sublist">
                        ...
                        <li id="this-page"><a href="<c:url value='/user/user-mypageModify.do' />">회원정보수정</a></li>
                        <li><a href="#">회원탈퇴</a></li>
                    </ul>
                </div>
            </nav>  
