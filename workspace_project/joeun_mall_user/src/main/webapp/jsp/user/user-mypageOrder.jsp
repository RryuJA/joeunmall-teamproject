...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value='/css/user-nav-mypage.css' />">
...
<body>
    <div id="wrap">
        <header>
            ...
            <a href="/user/user-mypageOrder.do"><img src="<c:url value='/images/icon/icon_user.png' />"></a>
            ...
            <nav>
                ...
                <div class="mypage-list">
                    ...
                    <ul class="mypage-sublist">
                        ...
                        <li><a href="<c:url value='/user/user-update.do'/>">회원정보 수정</a></li>
                        <li><a href="#">회원탈퇴</a></li>
                    </ul>
                </div>
            </nav>  
